...
**Still outstanding on the human check:** a third run after the mute deploy — words while speaking, one clean reply, no phantom turns — and hearing, rather than counting bytes of, the audio.

...
**Phase 0 exit:** both gate files have exactly one box ticked, and any spec amendment they required is committed. **Not reached.** `data/GATE_D.md` has its box; `data/GATE_L.md` has none and cannot get one until a deployed service is measured. No Phase 1 work may begin.
